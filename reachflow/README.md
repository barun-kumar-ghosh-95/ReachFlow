...
| Page | URL | Purpose |
|------|-----|---------|
| 🏠 **Landing Page** | [http://localhost:3000](http://localhost:3000) | Marketing page with features, pricing, and live preview |
| 🔐 **Sign In** | [http://localhost:3000/login](http://localhost:3000/login) | Authentication with demo pre-fill options |
| 📝 **Sign Up** | [http://localhost:3000/register](http://localhost:3000/register) | Account creation & workspace onboarding |
| 📊 **Dashboard** | [http://localhost:3000/dashboard](http://localhost:3000/dashboard) | Main multi-tenant workspace dashboard |
| 📣 **Campaigns** | [http://localhost:3000/campaigns](http://localhost:3000/campaigns) | WhatsApp & Email campaign manager |
| 👥 **Contacts** | [http://localhost:3000/contacts](http://localhost:3000/contacts) | Audience segmentation & CSV import |
| 📈 **Analytics** | [http://localhost:3000/analytics](http://localhost:3000/analytics) | Real-time delivery rates, open rates & CTR |
| 💳 **Billing** | [http://localhost:3000/billing](http://localhost:3000/billing) | Subscription plans, usage meter & invoices |
| ⚙️ **Settings** | [http://localhost:3000/settings](http://localhost:3000/settings) | Workspace, WhatsApp Cloud API & Email keys |
